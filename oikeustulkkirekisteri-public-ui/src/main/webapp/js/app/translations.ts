const translationFI = {
  ...
  kuvaus_kaytosta_3: 'Jos rekisterissä on toimintahäiriö, ota yhteyttä sähköpostitse saadaksesi oikeustulkkien yhteystietoja:',
...
const translationSV = {
  ...
  kuvaus_kaytosta_3: 'I fall av ett funktionsfel i registret vänligen kontakta vår e-postadress för att få kontaktuppgifter av rättstolkarna',
